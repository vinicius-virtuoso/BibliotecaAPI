...
export class AlterPassowrd1683928748573 implements MigrationInterface {
    name = 'AlterPassowrd1683928748573'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "followers" ADD CONSTRAINT "FK_d2e4bf20c4f674105f2e786d77a" FOREIGN KEY ("bookId") REFERENCES "books"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "loans" ADD CONSTRAINT "FK_c75c2327ce6368e9c120a5326cd" FOREIGN KEY ("copyId") REFERENCES "copys"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
